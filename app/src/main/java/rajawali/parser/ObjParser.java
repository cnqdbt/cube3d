...
/**
 * The most important thing is that the model should be triangulated. Rajawali  accept quads, only tris. In Blender, this is an option you can select in the exporter. In a program like MeshLab, this is done automatically.
